...
class MainMenuState extends MusicBeatState
{
	...
	public static var curLRSelected:Int = 0;
	...
	override function create()
	{
		...
		var bg:FlxSprite = new FlxSprite(0).loadGraphic(Paths.image('mainmenu/menuBG'));
        bg.scrollFactor.set(0, 0);
        bg.setGraphicSize(1366);
        bg.updateHitbox();
        ...
        var watermark:FlxSprite = new FlxSprite(0).loadGraphic(Paths.image('mainmenu/menuWatermark'));
        watermark.scrollFactor.set(0, 0);
        watermark.setGraphicSize(1280);
	...
	function changeItem(huh:Int = 0)
	{
		...
		if (huh == 1 && ((curLRSelected == 0 && curSelected == 3) || (curLRSelected == 1 && curSelected == 2)))
		{
			curSelected += 1;
		}
	...
	function changeLRItem(huh:Int = 0)
	{
		curLRSelected += huh;
